...
```js
// Usage
import { REG, APPID, CREATE, TIME_FORMAT, DEV } from '@b1/utils';

console.log(REG.email, APPID.acme, CREATE, TIME_FORMAT, DEV);
// /^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/ '3859b4f75fc61' 'CREATE' 'YYYY-MM-DD HH:mm:ss' 'development'
```
